$(document).ready(function() {
    ...
    $('#image7').css('background-image', 'url('+path+bg+')');
    ...
    $('#image8').css('background-image', 'url('+path+bg+')');
    ...
    $('#image9').css('background-image', 'url('+path+bg+')');
    ...
    $('#image10').css('background-image', 'url('+path+bg+')');
    ...
    $('#image11').css('background-image', 'url('+path+bg+')');
    ...
    $('#image12').css('background-image', 'url('+path+bg+')');
    ...
    $('#image13').css('background-image', 'url('+path+bg+')');
    ...
    $('#image14').css('background-image', 'url('+path+bg+')');
